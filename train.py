...
if __name__ == '__main__':
  ...
  if isTrainEncoder:
    print('------------------------------train encoder---------------------------------')
    net_encoder = AttentionUNet(n_channels=1, n_classes=1, encoder=True, bilinear=args.bilinear)
    print(f'''Network:\n
    ...
    # ============== AttentionUNet ======================
    net_decoder = AttentionUNet(n_channels=1, n_classes=args.classes, encoder=False, bilinear=args.bilinear)
    """ print(f'''Network:\n
